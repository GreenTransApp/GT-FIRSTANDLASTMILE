...
import 'package:gtlmd/pages/tripSummary/tripSummaryViewModel.dart';
...
class TripSummary extends StatefulWidget {
  TripModel model;
  TripSummary({super.key, required this.model});
...
// final TripSummaryViewModel viewModel = TripSummaryViewModel();
  ...
  TripSummaryViewModel viewModel = TripSummaryViewModel();
  @override
  void initState() {
    super.initState();
  ...
  void getTripSummary() {
    ...
    viewModel.getTripSummary(params);
  }
