...
class _CommonBottomSheetWithApiState extends State<BranchSelectionBottomSheet> {
                          ...
                          child: ListView.separated(
                            ...
                            itemBuilder: (context, index) {
                              return ListTile(
                                ...
                                title: Text(
                                  filteredList[index].stnName.toString(),
...
Future<void> showBranchSelectionBottomSheet<T>(
