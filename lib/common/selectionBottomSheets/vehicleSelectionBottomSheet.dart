...
class VehicleSelectionBottomSheet extends StatefulWidget {
  ...
  State<VehicleSelectionBottomSheet> createState() =>
      _VehicleSelectionBottomSheet();
}

class _VehicleSelectionBottomSheet extends State<VehicleSelectionBottomSheet> {
  ...
  void callApi() async {
    ...
    try {
      ...
      CommonResponse resp =
          await apiGet("${manifestBaseUrl}GetVehicleListV3", params);

      if (resp.commandStatus == 1) {
        List<dynamic> list =
            await compute(parseListIsolate, resp.dataSet.toString());
        List<VehicleModel> resultList = List.generate(
            list.length, (index) => VehicleModel.fromJson(list[index]));
                          ...
                          child: ListView.separated(
                            ...
                            itemBuilder: (context, index) {
                              return ListTile(
                                ...
                                title: Text(
                                  filteredList[index].vehicleCode.toString(),
...
Future<void> showVehicleSelectionBottomSheet<T>(
      ...
      builder: (BuildContext context) {
        return FractionallySizedBox(
          ...
          child: Padding(
              ...
              child: VehicleSelectionBottomSheet(
                callback: callback,
              )),
        );
      });
